...
Section "EXERoot" SEC01
  ...
  File "EXERoot\TestResult\ZS012001000210.json"
...
Section Uninstall
  ...
  Delete "$INSTDIR\TestResult\ZS012001000210.json"
  ...
  Delete "$INSTDIR\Firmware\sqdb.db"
  Delete "$INSTDIR\Firmware\readme.txt"
  Delete "$INSTDIR\Firmware\partitions_two_ota.bin"
  Delete "$INSTDIR\Firmware\ota_data_initial.bin"
  Delete "$INSTDIR\Firmware\msocket.bin"
  Delete "$INSTDIR\Firmware\DynamicTest.db"
  Delete "$INSTDIR\Firmware\bootloader.bin"
